...
function Showprojects() {
  ...
  const fetchProjects = async (queryoption = "", querytype = "Skill") => {
    ...
    try {
      ...
      if (queryoption !== "") {
        console.log(`/getprojectsby${type}?q=${queryoption}`);
        const results = await server.get(
          `/getprojectsby${type}?q=${queryoption}`
        );
        const resultsData = results.data;
        console.log("result is: ", resultsData);
        setFilterProject(resultsData);
        setProjects(resultsData);
        setFilteredProjects(resultsData);
  ...
  useEffect(() => {
    console.log("hello : ", filteredprojects);
  }, [filteredprojects]);
  ...
  return (
    <div className="showProjects">
      ...
      <div className="projectsList">
        {filterProject && dataCheck === "some data" ? (
          filterProject
